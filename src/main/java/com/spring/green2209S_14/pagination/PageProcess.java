...
public class PageProcess {
	...
	public PageVO totRecCnt(int pag, int pageSize, String section, String part, String searchString, String searchStart, String searchEnd) {
		PageVO pageVO = new PageVO();
		...
		if(section.equals("booking")) {
			totRecCnt = bookingDAO.totRecCnt(pag, pageSize, section, part, searchString, searchStart,searchEnd);
		}
