...
<p><br/></p>
<div class="loginWrap">	
	<form name="myform" class="was-validated"> <!-- 입력시켜 데이터베이스에 보내는..  -->
		<h2>reservation</h2>
  ...
  <button class="btn" onclick="filterSelection('people')"> #반영구</button>
		...
		<div class="row">
		  ...
		  <div class="column nature">
		    <div class="content">
		    <img src="${ctp}/images/161.jpg" alt="Lights" style="width:100%">
		      <div class="pMenuBox">
		      	<p class="pMenu">벨벳모</p>
		      	<p>풍성하면서도 가벼운 100% 고급 벨벳모로 눈에 이물감과 피로감이 적습니다</p>
		      </div>
		  ...
		  <div class="column nature">
		    <div class="content">
		    <img src="${ctp}/images/161.jpg" alt="Nature" style="width:100%">
		      <div class="pMenuBox">
		      	<p class="pMenu">벨벳모</p>
		      	<p>풍성하면서도 가벼운 100% 고급 벨벳모로 눈에 이물감과 피로감이 적습니다</p>
		      </div>
		  ...
		  <div class="column cars">
		    <div class="content">
		      <img src="${ctp}/images/161.jpg" alt="Car" style="width:100%">
		      <div class="pMenuBox">
		      	<p class="pMenu">벨벳모</p>
		      	<p>풍성하면서도 가벼운 100% 고급 벨벳모로 눈에 이물감과 피로감이 적습니다</p>
		      </div>
