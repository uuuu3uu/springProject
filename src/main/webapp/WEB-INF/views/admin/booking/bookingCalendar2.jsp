	  ...
	  <div class="adminWarp" style="margin-bottom:50px">
		  <div class="adminTitle">
			...
			<div class="adminWrap2" style="padding: 20px 0px; border-radius: 1em; min-width: 700px">
			    <table class="table bookingCalendar mt-5" style="width:100%; height:700px; ">
			      ...
			      <tr>
			        ...
			        <c:forEach begin="1" end="${lastDay}" varStatus="st">
			          ...
			          <td id="td${cnt}" ${todaySw==1 ? 'class=today' : ''} onclick="datePick('${yy}-${mm+1}-${st.count}')" style="font-size:0.9em" data-toggle="modal" data-target="#myModal">
